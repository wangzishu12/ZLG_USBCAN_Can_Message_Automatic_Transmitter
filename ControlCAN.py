...
class ControlCAN:
    ...
    def __init__(self, devtype=4, devindex=0, canindex=0, baudrate=250, acccode=0x00000000, accmask=0xFFFFFFFF):
        #根据官方给的波特率查表所得
    ...
    def transmit(self):
        ...
        for i in self.sendbuf:
            if i.ID != 0x0:
                frame_num += 1
        result = self.CANdll.VCI_Transmit(self.devtype, self.devindex, self.canindex, byref(self.sendbuf), frame_num)
        self.clear_sendbuf()
        return result
